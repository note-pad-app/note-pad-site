          ...
          <div className='view-todo border-rounded-3 shadow-sm p-2 pb-5 mt-3 bg-white'>
            <div className='d-flex justify-content-start align-items-center border-bottom mt-2'>
              <div className='text-decoration-none d-flex align-items-center w-100'>
                <input type="text" placeholder="new todo" className='w-100 border-0 px-2 py-2' style={{ outline: 'none' }} />
              </div>
            </div>
            <div className='d-flex justify-content-start align-items-center border-bottom mt-2'>
              <i className='fas fa-bell m-3 fs-4'></i>
              <div className='text-decoration-none d-flex align-items-center w-100'>
                <input type="datetime-local" className='w-100 border-0 px-2 py-2 form-control' />
              </div>
            </div>
            <div className='d-flex justify-content-start align-items-center border-bottom mt-2'>
            ...
            <button className='btn mt-3 btn-primary rounded-3 px-4 py-2 shadow-sm'>Add</button>
          </div>
        </div>
      </main>
    )
